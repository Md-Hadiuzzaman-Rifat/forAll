...
const DetailsContent = ({ desc, img }) => {
  ...
  return (
    <div className="  w-full sm:w-auto md:w-8/12 lg:w-6/12 items-center">
      ...
      {/* // warning  */}
      <div style={warning ? { display: "block" } : { display: "none" }}>
        <p className="bg-red-200 border font-semibold text-red-700 border-red-700 rounded-sm p-2 text-center mt-2 duration-100 font-mont text-md">
      ...
      {stock && (
        <div>
          ...
          {/* // quantity end  */}
            ...
            <button onClick={()=>addCount()} className="focus:outline-none focus:ring-2 duration-200 hover:bg-red-700 focus:ring-offset-2 focus:ring-gray-800  text-sm text-white tracking-wide bg-orange-500 w-full py-2 lg:mt-4 mt-2 font-medium flex items-center justify-center gap-2">
            ...
            className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 duration-200 focus:ring-gray-800 font-medium text-sm leading-4 text-white bg-blue-600 w-full py-3 lg:mt-4 mt-2"
          >
            পেমেন্ট করুন
          </button></Link>}
          
          <a href="tel:+8801648141727" className="flex items-center gap-2">
            <button className="focus:outline-none focus:ring-2 duration-200 bg-green-500 focus:ring-offset-2 focus:ring-gray-800  text-sm text-white tracking-wide hover:bg-gray-500 w-full py-2 lg:mt-4 mt-2 font-medium">
